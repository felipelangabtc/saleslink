      ...
      <ul className="projects-list">
        <li className="projects-list-item">
          <a href="https://www.amazon.com.br/dp/B0FHFY3YMN" target="_blank" rel="noopener noreferrer">
            eBook - Bitcoin para Iniciantes e Negócios - Amazon
          </a>
        </li>
        <li className="projects-list-item">
          <a href="https://www.amazon.com.br/dp/B0FHFY3YMN" target="_blank" rel="noopener noreferrer">
        ...
        <li className="projects-list-item">
          <a href="https://go.hotmart.com/B100767609F" target="_blank" rel="noopener noreferrer">
            eBook - Bitcoin para Iniciantes e Negócios - Hotmart
          </a>
        </li>
      </ul>
    </nav>
